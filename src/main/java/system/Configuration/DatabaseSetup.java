...
public class DatabaseSetup implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //attractionRepo.save(new Attraction(9L, "Kongens bakke",  "Her ser du Kongens bakke", "Natur", 55.3179035, 15.1888505, 2));
            attractionRepo.save(new Attraction(10L, "Den blå hanes hus",  "Her kan du opleve den blå hanes hus helt tæt på", "Bygning", 55.3184577, 15.1899624, 2));
        ...
        //attractionRepo.save(new Attraction(12L, "Verdens ende!",  "Her er verdens ende -Et af de absolut yderste punkter i Danmark", "Natur", 55.3194523, 15.1914865, 2));
            attractionRepo.save(new Attraction(13L, "Danmarks østligste punkt i Danmark",  "Det østligste punkt i Danmark ", "Natur", 55.3194966, 15.1914682, 2));
        ...
        //attractionRepo.save(new Attraction(23L, "Telt & hytte mm.",  "Her kan man overnatte", "Natur/Bygning", 55.3218028, 15.1899838, 2));
            attractionRepo.save(new Attraction(24L, "Æble plantage",  "Her kan du se en æble plantage", "Natur", 55.3212630, 15.1891052, 2));
        ...
        //attractionRepo.save(new Attraction(28L, "Ruin ",  "Her kan du opleve en ruin", "Bygning", 55.3209214, 15.1880076, 2));
            attractionRepo.save(new Attraction(29L, "Latter fr&oslash;er",  "Her er der tidligere set latter frøer ", "Natur", 55.3204756, 15.1876427, 2));
        ...
        //attractionRepo.save(new Attraction(31L, "Trappe",  "Trappe", "Bygning", 55.3195776, 15.1849335, 2));
            attractionRepo.save(new Attraction(32L, "Fængsel",  "Her kan du opleve Christian Ø's fængsel", "Bygning", 55.3199894, 15.1845679, 2));
        ...
        //attractionRepo.save(new Attraction(40L, "Trappe",  "Trappe", "Bygning", 55.3204373, 15.1872110, 2));
            attractionRepo.save(new Attraction(41L, "Fyrtårn",  "Christians Ø's fyrtårn", "Bygning", 55.3204645, 15.1872536, 2));
        ...
        //attractionRepo.save(new Attraction(46L, "Trappe",  "Trappe", "Bygning", 55.3195648, 15.1895525, 2));
            attractionRepo.save(new Attraction(47L, "Sæler",  "Til at teste implementation af billede og lyd (konceptuel attraction)", "Dyr", 55.3225185,15.1906426, 2,"Seal.jpg","BabySealSounds.mp3"));
